...
export default function Create ({ auth, offices, external }) {
  const {data, setData, post, errors, reset} = useForm({
    company_name: external.company_name || "",
    manager_name: external.manager_name || "",
    office_id: external.office.id || "",
  ...
  const onSubmit = (e) => {
    e.preventDefault();
    post(route('external.update', external.id));
  }
