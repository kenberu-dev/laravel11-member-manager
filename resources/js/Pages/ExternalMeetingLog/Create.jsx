...
export default function Create ({ auth, externals, meetingLogs, queryParams = null}) {
  queryParams = queryParams || {}

  const {data, setData, post, errors, reset} = useForm({
    title: "",
    user_id: auth.user.id ?? "",
    external_id: queryParams.external ?? "",
    meeting_log: "",
  })
  ...
  const externalChanged = (value) => {
    ...
    router.get(route('external.meetinglog.create'), queryParams);
  }
