...
export default function Dashboard({ auth, meetingLogs, messageCount = 0, meetingLogCount = 0, members, queryParams = null }) {
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
              <div className="p-6 text-gray-900 dark:text-gray-100">
                <label className="text-xl">昨日までに受信したメッセージ</label>
                <div className="text-3xl text-right font-bold">{messageCount}件</div>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
              <div className="p-6 text-gray-900 dark:text-gray-100">
                <label className="text-xl">今週作成した面談記録</label>
                <div className="text-3xl text-right font-bold">{meetingLogCount}件</div>
              </div>
            </div>
          </div>
        </div>
